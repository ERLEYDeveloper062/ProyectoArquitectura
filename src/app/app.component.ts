...
import { ElementoProcesador } from './Enumeraciones/elemento-procesador';
import { EstadoComputador } from './Enumeraciones/estado-computador';
import { Instruccion } from './modelos/instruccion';
import { ALU } from './modelos/alu';
import { Memoria } from './modelos/memoria';
import { AlmacenGeneral } from './modelos/almacen-general';
import { EjecutarTareaService } from './ejeecucion/ejecutar-tarea.service';
...
export class AppComponent {
  ...
  private async ejecutarInstruccionesGuardadas() {
    await this.ejecutarTareaService.ejecutarTareaDespuesDeUnTiempo(() => {
    ...
    await this.ejecutarTareaService.ejecutarTareaDespuesDeUnTiempo(async () => {
